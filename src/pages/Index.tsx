          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-white p-3 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105">
                <img alt="Dr. Soumya Hegde in her office" className="w-full h-[500px] object-cover object-center rounded-xl" src="/lovable-uploads/d2a52f41-086d-4bdd-b753-d979277c6651.png" />
              </div>
            </div>
            <div>
              <div className="inline-flex items-center px-4 py-2 bg-medical-teal/10 rounded-full mb-6">
      ...
      <section className="py-16 bg-gradient-to-br from-medical-deep-blue to-medical-charcoal text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/contact">
              <Button variant="outline" className="border-white hover:bg-white hover:text-medical-deep-blue px-8 py-3 text-lg font-inter transition-all duration-300 hover:scale-105 text-slate-950">
                Contact Our Office
              </Button>
            </Link>
          </div>
