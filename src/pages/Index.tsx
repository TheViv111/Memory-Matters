...
import { Heart, Users, Calendar, Shield, MapPin } from 'lucide-react';
import { CredentialsGrid } from '@/components/ui/Credentials';
import ContactHelpSection from '@/components/contact/ContactHelpSection';
import { Reveal, RevealList, RevealItem } from '@/components/animations/Reveal';
          ...
          <RevealList className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <RevealItem key={index}>
                <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 bg-white border-0 shadow-lg h-full">
