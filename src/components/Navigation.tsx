          ...
          <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
            {[
              ...
              <Link
                key={item.path}
                to={item.path}
                className={`font-inter font-medium transition-all duration-200 relative group px-3 py-2 rounded-lg ${isActive(item.path)
            ...
            <div className="px-4 py-4 space-y-3">
              {[
                ...
                <Link
                  key={item.path}
                  to={item.path}
                  className={`block font-inter font-medium transition-all duration-200 px-3 py-2 rounded-lg ${isActive(item.path)
                    ? 'text-medical-teal bg-medical-teal/10'
                    : 'text-gray-700 hover:text-medical-teal hover:bg-gray-50'
                    }`}
                  onClick={handleLinkClick}
