      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal direction="up" delay={0.4}>
          <div className="text-center mt-16">
            <div className="bg-gradient-to-br from-medical-deep-blue to-medical-teal rounded-3xl p-8 text-white">
              <h3 className="font-playfair text-3xl mb-4">Ready to Experience Exceptional Care?</h3>
              <p className="font-inter text-xl opacity-90 mb-6">
                Join the families who have found hope and healing through our compassionate approach
              </p>
