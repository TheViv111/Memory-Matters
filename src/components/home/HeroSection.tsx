      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 pt-20 min-h-screen flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start w-full">
          ...
          <div className="animate-fade-in">
            ...
            <h1 className="font-playfair text-4xl md:text-6xl lg:text-7xl text-medical-charcoal mb-8 leading-tight">
              Expert Care for
              ...
              <span className="block text-medical-deep-blue text-3xl md:text-5xl lg:text-6xl mt-2">
                & Mental Wellness
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Link to="/appointment" className="w-full sm:w-auto">
                <Button className="w-full bg-gradient-to-r from-medical-deep-blue to-medical-teal hover:from-medical-teal hover:to-medical-deep-blue text-white px-8 py-4 text-lg font-inter shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 rounded-xl">
