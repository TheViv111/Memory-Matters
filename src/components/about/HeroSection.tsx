        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <ScrollReveal direction="right" delay={0.2}>
            <div className="relative">
              ...
              }} className="w-full h-96 rounded-2xl object-cover" src="https://th.bing.com/th/id/OIP._qKVdNOKwA0IaxoeKKvw_wHaD4?w=314&h=180&c=7&r=0&o=7&dpr=1.5&pid=1.7&rm=3" />
